const dataset = {
    ...
    informingStrategicDecisions: {
        ...
        situationAnalyses: {code: '02', name: 'Situation Analyses', names: {en: 'Situation analysis',fr: 'Analyses de la situation'}, noteName: {en:'Notes from the Coordinator', fr: 'Notes du coordinateur'},notes: [{code: 'C_IS03', name: 'Has the cluster done any situation analysis over the last year?'}]},
    ...
    preparedness: {
        ...
        preparednessPlan: {code: '01', starting: 1, end: 5, name: 'Preparedness Plans', noteName: {en:'Notes from the Coordinator', fr: 'Notes du coordinateur'},notes: [{code: 'C_PR02', name: 'Is preparedness for recurrent disasters relevant for this cluster?'},{code: 'C_PR01', name: 'Notes on Preparedness for Recurrent Disasters'}]},
    },
    aap: {
        code: 'P_AA',
