const dataset = {
    supportServiceDelivery: {
        ...
        clusterStrategicDecisions : {code : '02', starting: 1, end: 3, name: 'Cluster Strategic Decisions', names: {en: 'Cluster Strategic Decisions',fr: 'Décisions stratégiques du Groupe'},noteName: 'Notes from the Coordinator', notes: [{code: 'C_SD03', name: ''}]},
        clusterMapping: {code: '03', starting: 1, end: 5, name: 'Cluster Mapping', names: {en: 'Cluster Mapping',fr: 'Mappage du groupe'}, noteName: 'Notes from the Coordinator', notes: [{code: 'C_SD04', name: ''}]},
        identificationNeeds: {code: '04', starting: 1, end: 3, name: 'Identification of Needs, Gaps and Response Priorities', names: {en: 'Identification of Needs, Gaps and Response Priorities',fr: 'Identification des besoins, des lacunes et des priorités de réponse'}, noteName: 'Notes from the Coordinator', notes: [{code: 'C_SD05', name: ''}] },
    },
    informingStrategicDecisions: {
        ...
        assesments: {code: '01', starting: 1, end: 7, name: 'Assessments', names: {en: 'Assessments',fr: 'Évaluations'}, noteName: 'Notes from the Coordinator',notes: [{code: 'C_IS01', name: 'Have Assessments, Tools and Guidance been agreed?'},{code: 'C_IS02', name: 'Have there been any coordinated assessments (that include a focus on health) over the last year?'}]},
        situationAnalyses: {code: '02', name: 'Situation Analyses', names: {en: 'Assessments',fr: 'Analyses de la situation'}, noteName: 'Notes from the Coordinator',notes: [{code: 'C_IS03', name: 'Has the cluster done any situation analysis over the last year?'}]},
        ...
        supportDecisionMaking: {code: '05', starting: 1, end: 2, name: 'Support for Decision Making', names: {en: 'Support for Decision Making',fr: 'Aide à la prise de décision'}, noteName: 'Notes from the Coordinator',notes: [{code: 'C_IS04', name: ''}]},
    },
    planningStrategyDevelopment: {
        ...
        strategicPlan: {code: '01b', starting: 1, end: 4, name: 'Strategic Plan', names: {en: 'Strategic Plan',fr: 'Plan stratégique'},  noteName: 'Notes from the Coordinator',notes: [{code: 'C_PS01', name: 'Has the cluster developed a strategic plan?'}]},
        technicalStandard: {code: '02', starting: 1, end: 2, name: 'Technical standards and guidelines',names: {en: 'Technical standards and guidelines',fr: 'Normes techniques et directives'},noteName: 'Notes from the Coordinator',notes: [{code: 'C_PS02', name: 'Have technical standards and guidelines been agreed?'}]},
        ...
        updateFundingStatus: {code: '02', starting: 6, end: 6, name: 'Updates on funding status against needs', names: {en: 'Updates on funding status against needs',fr: 'Mises à jour sur l\'état du financement par rapport aux besoins'}, noteName: 'Notes from the Coordinator',notes: [{code: 'C_PS04', name: 'How often does the cluster report on funding status against needs?'}, {code: 'C_PS05', name: 'Notes on Planning and Strategy Development'}]}
    },
    advocacy: {
        code: 'P_AD',
        name: 'Advocacy',
        ...
        discussionAdvocacyIssue: {code: '01', starting: 2, end: 5, name: 'Discussion on advocacy issues', names: {en: 'Discussion on advocacy issues',fr: 'Discussion sur les questions de plaidoyer'}, noteName: 'Notes from the Coordinator',notes: [{code: 'C_AD01', name: ''}]}
    },
    monitoringReporting: {
        code: 'P_MR',
