...
export const datasetGroup = {
    ...
    informingStrategicDecisions: {
        ...
        organisationParticipating: {names: {en: 'Organizations participation in joint situation analyses', fr: 'Organisations participant à des analyses de situation conjointes'}, 
                                       code: '02', stackedLabels: [['Participated', 'A participé'], ['Did not Participate', 'N\'a pasparticipé']]},
    ...
    planningStrategyDevelopment: {
        ...
        clusterPartnersAgreedTechnical: {names: {en: 'Cluster partners agreed technical standards and guidance and have applied them', fr: 'Les partenaires CLuster ont convenu de normes et d\'orientations techniques et les ont appliquées'}, wholeCode: 'C_PS02', stackedLabels: [['Agreed', 'D\'accord'], ['Disagreed','Pas d\'accord']]},
