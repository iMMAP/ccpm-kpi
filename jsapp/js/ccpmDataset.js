...
export const datasetGroup = {
    supportServiceDelivery: {
        ...
        names: { en: 'Support to Service Delivery', fr: 'Appui à la Prestation de Services' },
        code: 'P_SS',
        partnerSatisfaction : {names: {en: 'Partner satisfaction with meeting frequency', fr: 'Satisfaction du partenaire TODO'}, code: '01a_01' },
        organizationAbility: {names: {en: 'Organizations ability to participate fully in cluster meetings (access language)', fr: 'Capacité d\'organisation TODO'}, code: '01a', starting: 2, end: 4},
        clusterMeetingAbility: {names: {en: 'Cluster meeting ability to identify and discuss needs, gaps and response priorities', fr: 'Capacité de réunion de cluster TODO'}, code: '04', starting: 1, end: 3},
        clusterAbilityStrategic: {names: {en: 'Cluster ability to take strategic decisions about the direction of the response', fr: 'capacité du cluster à prendre des décisions stratégiques TODO'}, code: '02', starting: 1, end: 3},
        frequencyPartnerContribution: {names: {en: 'Frequency of partner contribution to 3W mapping', fr: 'Contribution du partenaire de fréquence TODO'}, code: '03', starting: 1, end: 2},
        partnerContribution: {names: {en: 'Partner contribution to analysis of gaps and overlaps in 3W data', fr: 'Contribution du partenaire TODO'}, code: '03_03'},
        useOfClusterAnalysis: {names: {en : 'Use of cluster analysis of gaps and overlaps in partner decision making', fr: 'Utilisation de l\'analyse de cluster TODO'}, code: '03', starting: 4, end: 5}
    },
    informingStrategicDecisions: {
    ...
    monitoringReporting: {
        ...
        names: { en: 'Monitoring and Reporting on Implementation of Cluster Strategy and Results', fr: 'Surveillance et Rapports TODO' },
        ...
        hasTheclusterTaken: {names: {en: 'Has the cluster taken into account the distinct needs, contributions and capacities of women, girls, men and boys in its response and monitoring', fr:'Le cluster a-t-il pris en compte les besoins, les contributions et les capacités du district TODO (no district but distinct) des femmes, des filles, des hommes et des garçons dans sa réponse et son suivi'}, code: '01_05'}
    },
    preparednessPlan: {
        code: 'P_PR',
        name: 'Preparedness for Recurrent Disasters',
        names: { en: 'Preparedness for Recurrent Disasters', fr: 'Préparation aux Catastrophes Récurrentes' },
        organizationHelped: {names: {en: 'Organizations helped to develop or update preparedness plans (including multisectoral ones) that address hazards and risks', fr: 'L\'organisation a aidé à élaborer ou à mettre à jour des plans de préparation (y compris multisectoriels) qui traitent des dangers et des risques'}, code: '01', starting: 1, end: 3, stackTitle: [['Regional breakdown of responses to "Has your organization helped to develop or', 'update preparedness plans (including multisectoral ones) that address hazards and risks?". Shown in terms of','how adequately partners felt their contributions were reflected.'], ['Répartition régionale des réponses à "Votre organisation a-t-elle aidé à élaborer ou à mettre à jour des','plans de préparation (y compris des plans multisectoriels) qui traitent des dangers et des risques?". TODO (missing the last sentence)']], stackedChart: true, stackedLabels: [['No plan developed / updated', 'Aucun plan développé / mis à jour'], ['Not invited to participate', 'Non invité à participe'], ['Did not contribute', 'N\'a pas contribué'], ['Inadequately reflected', 'Insuffisamment reflété'], ['Adequately reflected', 'Correctement reflété']]},
    ...
    accoutabilityAffected: {
        ...
        clusterPartnersConsulting: {names: {en: 'Cluster partners agreed and applied mechanisms (procedures, tools or methodologies) for consulting and involving affected people in decision-making', fr: 'Partenaires du cluster TODO (agreed word was missing) et mécanismes appliqués (procédures, outils ou méthodologies) pour consulter et impliquer les personnes affectées dans la prise de décision'}, code: '01', content: [1, 3], stackedChart: true, stackTitle: [['Regional breakdown of responses to "Cluster partners agreed and applied mechanisms (procedures, tools or methodologies)', 'for consulting and involving affected people in decision-making"'], ['Répartition régionale des réponses à "Votre organisation TODO? (word agreed was missing) a-t-elle aidé à', 'élaborer ou à mettre à jour des plans de préparation (y compris des plans multisectoriels)', 'qui traitent des dangers et des risques?" TODO (this does not seem the correct translation)']], stackedLabels: [['No mechanisms agreed', 'Pas de mécanismes convenus'], ['Never', 'Jamais'], ['Seldom', 'Rarement'], ['Sometimes', 'De fois'], ['Often', 'Souvent'], ['Always', 'Toujours']]},
        clusterPartnersReceiving: {names: {en: 'Cluster partners agreed and applied mechanisms (procedures, tools or methodologies) to receive, investigate and act on complaints by affected people', fr: 'Partenaires du cluster TODO (agreed word was missing) et mécanismes appliqués (procédures, outils ou méthodologies) pour recevoir, enquêter et agir sur les plaintes des personnes affectées'}, code: '01', content: [2,4], stackedChart: true, stackTitle: [['Regional breakdown of responses to "Cluster partners agreed and applied mechanisms (procedures, tools or methodologies)', 'to receive, investigate and act on complaints by affected people"'], ['Répartition régionale des réponses aux "Partenaires du cluster TODO (word agreed was missing) et mécanismes appliqués (procédures, outils ou méthodologies)', 'pour recevoir, enquêter et traiter les plaintes des personnes concernées"']], stackedLabels: [['No mechanisms agreed', 'Pas de mécanismes convenus'], ['Never', 'Jamais'], ['Seldom', 'Rarement'], ['Sometimes', 'De fois'], ['Often', 'Souvent'], ['Always', 'Toujours']]}
    }
}
